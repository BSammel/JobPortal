...
const Header = () => {
  ...
  className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-sm border-gray-100 shadow-lg"
    ...
    <div className="container mx-auto px-4">
        ...
        <div className="flex items-center space-x-3">
            {isAuthenticated ? (
                ...
                <a 
                    href="/login"
                    className="text-gray-600 hover:text-gray-900 transition-colors font-medium px-4 py-4 rounded-lg hover:bg-gray-500  "
                >
                    Login
                    </a>
                    <a
