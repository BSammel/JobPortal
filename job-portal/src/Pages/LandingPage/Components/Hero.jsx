...
const Hero = () => {
    ...
    const user = {fullName: "Sammel Bempong", role: "employer"};

    const navigate = useNavigate();

    const stats =[
        {icon: Users, label: 'Active Users', value: '3.7M+'},
        {icon: Building2, label: 'Companies', value: '150K+'},
    ...
    <section className="pt-24 pb-16 bg-white min-h-screen flex items-center ">
        <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
                ...
                className ="text-4xl md:text-5xl lg:text-5xl font-bold text-gray-900 nb-6 leading-tight pt-10"
                >
                ...
                <motion.button
                    ...
                    className ="grid grid-cols-1 md:grid-cols-3 gap-8 text-w-2xl mx-auto" 
                    >
                       {stats.map((stat, index) => (
                        <motion.div
                            ...
                            className="flex flex-col items-center space-y-2 p-4 rounded-xl hover:bg-gray-500 transition-colors "
                            >
                                <div className="w-12 h-12 bg-gradient-to-r from-blue-100 t0-purple-100 rounded-xl flex items-center justify-center mb-2">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
            ...
            <div className="absolute bottom-20 right-10 w-48 h-48 bg-purple rounded-full blur-3xl opacity-30" />
