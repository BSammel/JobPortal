...
import {
  Mail, Lock, User, UserCheck, Building2, Eye, EyeOff, Upload, AlertCircle, CheckCircle, Loader,
  LucideConstruction} from 'lucide-react';
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                    ...
                    className={`w-full pr-4 py-3 pl-10 bg-gray-100 rounded-lg border ${formState.errors.fullName ? 'border-red-500' : 'border-gray-300'} focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors`}
                ...
                {formState.errors.fullName && (
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      onChange = {handleInputChange}
                      className={`w-full pr-4 py-3 pl-10 bg-gray-100 rounded-lg border ${formState.errors.email ? 'border-red-500' : 'border-gray-300'} focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors`}
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    onChange={handleInputChange}
                    className={`w-full pl-10 pr-12 py-3 bg-gray-100 rounded-lg border ${formState.errors.password ? 'border-red-500' : 'border-gray-300'} focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors`}
                  ...
                  <div>
                    <label className="block text-sm font-medium textgray-700 mb-2">
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex-1">
                        ...
                        <div>
                        <label className="block text-sm font-medium text-gray-700 mb-4 mt-3">
                          I am a *
                        </label>
                  ...
                  {formState.errors.submit && (
                    <div className="text-red-50 border border-red-200 rounded-lg p-3">
